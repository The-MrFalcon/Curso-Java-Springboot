...
public class ClienteIT {
    ...
    @Test
    public void criarCliente_ComDadosValidos_RetornarClientesComStatus201(){
        ClienteResponseDTO responseBody = testClient
                .post()
                .uri("/api/v1/clientes")
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "tobi@email.com", "123456"))
                .bodyValue(new ClienteCreateDTO("Tobias Ferreira", "67266131057"))
                .exchange()
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("67266131057");
    }
    ...
    public void criarCliente_ComCpfJaCadastrado_RetornarErrorMessageStatus409(){
        ErrorMessage responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "tobi@email.com", "123456"))
                .bodyValue(new ClienteCreateDTO("Tobias Ferreira", "49245711056"))
                .exchange()
    ...
    public void criarCliente_ComDadosInvalidos_RetornarErrorMessageStatus422(){
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "tobi@email.com", "123456"))
                .bodyValue(new ClienteCreateDTO("Bobo", "24523452545"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "tobi@email.com", "123456"))
                .bodyValue(new ClienteCreateDTO("Bobob", "492.457.110-56"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    @Test
    public void buscarCliente_ComIdInexistentePeloAdmin_RetornarErrorComStatus404(){
        ErrorMessage responseBody = testClient
                .get()
    ...
    public void buscarCliente_ComDadosDoTokenDoCliente_RetornarClienteComStatus200(){
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody).isNotNull();
        org.assertj.core.api.Assertions.assertThat(responseBody.getCpf()).isEqualTo("52336338092");
        org.assertj.core.api.Assertions.assertThat(responseBody.getNome()).isEqualTo("Bianca Silva");
        org.assertj.core.api.Assertions.assertThat(responseBody.getId()).isEqualTo(10);
    }

    @Test
    public void buscarCliente_ComDadosDoTokenDeAdminstrador_RetornarErrorMessageComStatus403(){
        ErrorMessage responseBody = testClient
                .get()
                .uri("/api/v1/clientes/detalhes")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ana@email.com", "123456"))
